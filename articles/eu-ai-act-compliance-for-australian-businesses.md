...
This is the same enforcement logic Australian firms already met with the GDPR, so the compliance instinct is familiar: map where your outputs land, not just where your servers sit. A business that sells only into Australia and New Zealand, with no EU users and no EU-bound output, is outside the Act. One with EU customers, EU end users, or EU-facing content generation is inside it and should scope accordingly. Firms operating across the Tasman should read the companion guide on [EU AI Act compliance for New Zealand businesses](eu-ai-act-compliance-for-new-zealand-businesses.md), where the extraterritorial trigger is identical but the domestic backdrop differs. Businesses shipping physical goods or AI-embedded products into Europe should also read [what the EU AI Act means for Australian exporters](what-the-eu-ai-act-means-for-australian-exporters.md), which works through the value-chain roles and the product-embedded deadline.
