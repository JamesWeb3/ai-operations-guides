...
The layered model that works for any Australian business still holds here, but the base layer is heavier. Our general [AI governance framework for Australian businesses](ai-governance-framework-for-australian-businesses.md) sets out the stack; a financial firm loads more into the bottom of it. Healthcare is the other heavily regulated vertical that does the same from a different set of duties, which our guide to [AI governance for healthcare providers in Australia](ai-governance-for-healthcare-providers-in-australia.md) works through.
